...
// Write writes bytes to the intermediate file.
func (w *safeWriter) Write(b []byte) (int, error) {
	return w.w.Write(b)
}

// Close ends writes to the intermediate file, moves the existing file out of
// the way (if it exists), and ovewrites the existing file with the intermediate
// file using a rename operation.
